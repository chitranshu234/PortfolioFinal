...
const DEFAULT_GLOW_COLOR = '200, 194, 180';
                                ...
                                <div className="magic-bento-card__content">
                                    ...
                                    {card.credentialUrl && (
                                        <a
                                            ...
                                            style={{ color: '#c8c2b4', fontSize: '11px', marginTop: '6px', opacity: 0.6, textDecoration: 'none', letterSpacing: '0.1em', textTransform: 'uppercase' as const, position: 'relative', zIndex: 10 }}
